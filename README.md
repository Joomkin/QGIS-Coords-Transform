...
Transform Coords is a plugin to help convert coordinates from decimal or grades-minutes-seconds (DMS) to UTM (17S, 18S and 19S, so basically, Chilean territory). The user can also make a point in those coordinates. 
...
Then, select the UTM zone (17S, 18S or 19S). 
